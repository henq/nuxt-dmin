...
export default {
  ...
  methods: {
    ...
    turnToPage(route) {
      ...
      let newRoute = this.getRoute(Routers, route);
     let path = route.path;
     let meta = route.meta;
      this.$router.push({
        name,
  ...
  watch: {
    $route(newRoute) {
      console.warn("newRoute", newRoute);
      newRoute = this.getRoute(Routers, newRoute);
